...
from typing import Dict, Optional, List, Literal, ClassVar, Any, Union, Tuple
...
from findviz.viz.viewer.utils import (
    ...
    get_ortho_slice_coords, get_ts_minmax,
...
class DataManager:
    ...
    def create_gifti_state(
        ...
        functional and mesh GIFTI images must be provided.
